...
import {
  ChangeDatasetDescriptionGQL,
  ChangeDatasetNameGQL,
  DatasetExistsGQL
} from 'src/app/graphql/datasets/datasets.generated';
        ...
        <mat-expansion-panel-header>
          <mat-panel-title>
            ...
            <button
              ...
              (click)="openEditNameDialog(dataset)"
          ...
          <mat-panel-description>
            ...
            <button
              mat-mini-fab
              aria-label="Edit Name"
              (click)="openEditDescriptionDialog(dataset)"
              style="transform: scale(0.75)"
            >
              <mat-icon style="transform: scale(0.75)">edit</mat-icon>
            </button>
...
export class DatasetTable {
  ...
  openEditDescriptionDialog(dataset: Dataset) {
    this.dialog
      .open(EditDatasetDialog, { data: { field: 'description' } })
      .afterClosed()
