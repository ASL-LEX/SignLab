...
describe('ResponseService', () => {
  ...
  beforeEach(async () => {
    ...
    responseService = await module.resolve(ResponseService);
  });
  ...
  describe('uploadResponseDataCSV()', () => {
    it('single line CSV should fail', async () => {
      ...
      const result = await responseService.uploadResponseDataCSV(testInput);
  ...
  describe('uploadResponseVideos()', () => {
    it('should give warning on a ZIP file with not content', async () => {
      const result = await responseService.uploadResponseVideos('empty.zip');

      expect(result.type).toEqual('warning');
      expect(result.message).toContain('No response videos found');
    });
    ...
    it('should give warning if file does not have a cooresponding response upload', async () => {
      ...
      const result = await responseService.uploadResponseVideos(
    ...
    it('should work for ZIP that has the cooresponding ResponseUploads', async () => {
      ...
      const result = await responseService.uploadResponseVideos('all_good.zip');
